...
Ma nessun approccio si chiede se queste due dimensioni siano governate dallo stesso processo latente o da processi indipendenti --- la domanda viene semplicemente elusa, e un'unica etichetta di stato collassa livello e dinamica in una sola variabile.
